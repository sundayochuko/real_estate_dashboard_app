    ...
    <>
      {showModel ? (
        <div className="z-10 absolute h-full w-full ">
          ...
          ></div>
          <div className=" z-20 absolute h-full w-full overflow-y-scroll ">
            <div className=" z-20 absolute right-0 h-[1000px] w-[100%] md:w-[80%] lg:w-[30%] bg-white shadow-xl px-5 md:px-12 lg:px-12">
              <button
                onClick={() => {
                  setId("");
                  setProperty({});
